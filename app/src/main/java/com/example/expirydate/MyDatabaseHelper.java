...
class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_DAYSLEFT = "product_daysleft";
    ...
    void addproduct(String name, String daysleft,  int quantity){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();

        cv.put(COLUMN_NAME, name);
        cv.put(COLUMN_DAYSLEFT, daysleft);
    ...
    void updateData(String row_id, String pname, String pdaysleft, String pquantity){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv =new ContentValues();
        cv.put(COLUMN_NAME, pname);
        cv.put(COLUMN_DAYSLEFT, pdaysleft);
        cv.put(COLUMN_QUANTITY , pquantity);
